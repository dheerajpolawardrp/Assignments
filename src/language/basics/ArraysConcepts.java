...
//Array can store the multiple values with the similar data type at the same place	
	...
	public static void main(String[] args) {
		/*
		 * Storing data in Array 1. When we know the values before itself
		 * 
		 * Data-type variable = data; String [] employeename =
		 * {"Pooja","Mayuri","Tejas","Dheeraj"};
		 * 
		 * 2. When we don't know the values but we know the size of an array int []
		 * empid = new int [3]; empid [0] = 1; empid [1] = 2; empid [2] = 3;
		 * 
		 */
		/*
		 * Multi dimensional array: array in arary
		 * 
		 * String project1 = {"Pooja","Mayuri","Tejas","Dheeraj"}; String project2 =
		 * {"Saurabh" ,"Durga","Mayur","Asha"}; 1. When we know the values before itself
		 * String porjects [] [] {{"Pooja","Mayuri","Tejas","Dheeraj"},{"Saurabh"
		 * ,"Durga","Mayur","Asha"}};
		 * 
		 * 2.When we don't know the values but we know the size of an array
		 * 
		 * String [] [] projects = new String [2] [3]; projects[0][0] = "Pooja";
		 * projects[1][3] = "Asha";
		 */
//3D Array
