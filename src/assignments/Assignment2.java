...
public class Assignment2 {
	...
	public static void main(String[] args) {
		 ...
		 // 3D Array: [Semester][Subject/Marks][Values]
		        ...
		        System.out.println("Semester 3, Subject 4: " + studentdata[2][0][3]); // Operating Systems
		        System.out.println("Semester 3, Subject 5: " + studentdata[2][0][4]); // Signals and Systems

		        // Print marks of Semester 5, Subject 3 and Subject 6
		        System.out.println("Semester 5, Subject 3 Marks: " + studentdata[4][1][2]); // Compiler Design - Pass(84)
